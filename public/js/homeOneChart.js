// ✅ Destroy existing chart instance if it exists before rendering
if (window.lineChartInstance) {
    window.lineChartInstance.destroy();
}

window.lineChartInstance = new ApexCharts(document.querySelector("#chart"), { ...options });
    ...
    yaxis: {
        labels: {
            formatter: function (value) {
                return value;  // ✅ removed $k, just show view count
            },
            style: {
                fontSize: "14px"
            }
