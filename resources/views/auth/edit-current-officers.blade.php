<x-auth-dashboard>
    <title>Edit Current Officers - Centralino Flora</title>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            <x-auth-navbar-right>Edit Current Officers</x-auth-navbar-right>
            <form action="{{ route('about.update_current') }}" method="POST" enctype="multipart/form-data"
                onsubmit="return confirmSave()">
                @csrf
                @method('POST')
                @php
                    $officerMap = $currentOfficers->keyBy('position');
                    ...
                    <div class="row gy-4 mb-3">
                        ...
                        <div class="col-12">
                            <div class="card p-0">
                                <div class="card-header">
                                    <label class="form-label mb-0 fw-semibold">MCU Biological Society School
                                        Year</label>
                                </div>
                                <div class="card-body p-24">{{ $school_year }}
                                </div>
                            </div>
                        </div>
                        @foreach($positions as $positionName => $config)
                            @php
                                ...
                                // ✅ Find user using officer.id → users.officer_id
                                ...
                                <div class="card h-100 p-0">
                                    ...
                                    <div class="card-body h-100 p-24">
                                        <div class="upload-image-wrapper d-flex align-items-center gap-3">
                                            ...
                                            {{-- ✅ Single upload label that shows image as background --}}
                                            <label
                                                ...
                                                for="upload-file-{{ $idx }}" id="preview-wrapper-{{ $idx }}"
    ...
    <script>
        ...
        function previewOfficerImage(input, index) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    // ✅ Update background of the label itself
        ...
        function removePreview(index) {
            document.getElementById('preview-wrapper-' + index).classList.add('d-none');
        }
    </script>
